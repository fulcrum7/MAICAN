...
struct mcp251x_priv *glob_dev=NULL;
...
int mcp251x_can_ist(int irq, struct mcp251x_priv *dev_id)
{
	...
	if(dev_id<=NULL)
	{
		printk(KERN_WARNING "INTERRUPT ZERO POINTER!");		 
		return -1;
	}
	printk(KERN_WARNING "INTERRUPT OK POINTER!");	
	//priv=dev_id;
	//spi=priv->spi;
	//net=priv->net;
...
static int mcp251x_open(struct net_device *net)
{
	...
	glob_dev=priv;
	//mcp251x_can_ist(0,(void*)glob_dev);
	printk(KERN_WARNING "GLOB");
